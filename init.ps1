...
try {
    ...
    & $mkcert -install
    & $mkcert -cert-file cm.localhost.crt -key-file cm.localhost.key "cm.localhost"
    & $mkcert -cert-file id.localhost.crt -key-file id.localhost.key "id.localhost"
    & $mkcert -cert-file cd.localhost.crt -key-file cd.localhost.key "cd.localhost"
}
catch {
